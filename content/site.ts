  ...
  hy: {
    ...
    eligibility: {
      ...
      bullets: [
        ...
        "Ընդունվում են վերջին երեք տարիների ընթացքում իրականացված կամ շարունակվող այն լուծումները, որոնք արդեն ունեն ներկայացման և գնահատման ենթակա արդյունքներ։",
      ],
    ...
    placeholders: {
      juryTitle: "Ժյուրի",
      juryBody: "Մրցանակաբաշխության հայտերը կգնահատվեն ժյուրիի կողմից՝ միասնական չափորոշիչների և գնահատման համակարգի հիման վրա։ Ժյուրիի անդամների կազմը ներկայացվում է ստորև։",
  ...
  en: {
    ...
    eligibility: {
      ...
      bullets: [
        ...
        "Eligible solutions include those implemented or ongoing during the last three years and already demonstrating results that can be presented and assessed.",
      ],
